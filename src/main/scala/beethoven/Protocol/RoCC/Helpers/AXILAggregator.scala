...
// }
// import org.chipsalliance.diplomacy.{IdRange, LazyModule, LazyModuleImp}
...
// class AXILAggregatorModule(outer: AXILAggregator)(implicit p: Parameters)
...
//   val sIdle :: sWriteHasAddrHigh :: sWriteNeedData :: sWriteSend :: sReadHasAddrHigh :: sReadSendAddr :: Nil =
//     Enum(6)
//   val state = RegInit(sIdle)
//   val writeAddr = RegInit(0.U(nastiXAddrBits.W))
//   val writeCounter = RegInit(
//     0.U(log2Ceil(tlBlockBytes / p(PlatformKey).frontBusBeatBytes).W)
//   )
