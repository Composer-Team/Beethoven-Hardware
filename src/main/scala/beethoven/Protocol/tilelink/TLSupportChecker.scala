...
class TLSupportChecker(val check: TLEdgeIn => Boolean, val identifier: String)(
...
object TLSupportChecker {
  def apply(check: TLEdgeIn => Boolean, identifier: String = "")(implicit
      p: Parameters
  ): TLIdentityNode = {
