...
//   /** @param config
//     *   configuration that contains all of the accelerator information
//     * @param emitAllModules
//     *   enable if you want separate file for each module (recommended)
//     * @param performDeadCodeElimination
//     *   enable if you want dead code elimination (slow in FIRRTL, and makes
//     *   debugging much more difficult)
//     * @param targetDir
//     *   output directory
//     * @param c
//     *   class for top module
//     * @return
//     */
//   def apply(
//       config: Config,
...
//       targetDir: Path = BeethovenBuild.top_build_dir
//   ): AnnotationSeq =
//     AnnotationSeq(
//       Seq(
...
//       ) ++ (if (emitAllModules)
//               Seq(new EmitAllModulesAnnotation(classOf[VerilogEmitter]))
//             else Seq()) ++ (if (performDeadCodeElimination) Seq(NoDCEAnnotation)
//                             else Seq())
//     )
